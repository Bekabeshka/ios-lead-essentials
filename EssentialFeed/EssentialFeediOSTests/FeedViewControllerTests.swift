...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once loading completes with success")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator once user initiates a reload")
        
        loader.completeFeedLoadingWithError(at: 1)
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once user initiated loading completes with failure")
    }
    ...
    func test_feedImageView_loadsImageURLWhenVisisble() {
    ...
    class LoaderSpy: FeedLoader, FeedImageDataLoader {
        ...
        private struct TaskSpy: FeedImageDataLoaderDataTask {
        ...
        func loadImageData(from url: URL, completion: @escaping ((FeedImageDataLoader.Result) -> Void)) -> FeedImageDataLoaderDataTask {
